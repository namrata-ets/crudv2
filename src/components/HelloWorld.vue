...
<template>
  <div class="hello">
    ...
    <table border="1" style="margin: auto">
      <thead>
        <tr>
          <th style="width: 150px">Airline Name</th>
          <th style="width: 150px">Passenger Name</th>
          <th style="width: 150px">Number Of Trips</th>
      ...
      <tbody>
        <tr v-for="data in airlineData" v-bind:key="data.id">
          ...
          <td>{{ data.trips }}</td>
          <td>
            <button type="button" @click="updatePassenger(data._id)">
              Edit
            </button>
          </td>
          <td>
            <button type="button" @click="deletePassenger(data._id)">
              Delete
            </button>
          </td>
        </tr>
